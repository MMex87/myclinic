                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="noBPJS" id="noBPJS" style="width: 270px;" maxlength="13"
                                autocomplete="off" value="<?= (old('noBPJS')) ? old('noBPJS') : $pasien['no_bpjs'] ?>"
                        ...
                        <td>
                            <input type="text" name="nik" id="nik" style="width: 270px;" maxlength="16"
                                autocomplete="off" value="<?= (old('nik')) ? old('nik') : $pasien['nik'] ?>"
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="namaPasien" id="namaPasien" style="width: 270px;"
                                value="<?= (old('namaPasien')) ? old('namaPasien') : $pasien['nama'] ?>"></td>

                        <td><label for="noHP">No HP</label></td>
                        <td><input type="text" name="noHP" id="noHP" style="width: 270px;"
                                value="<?= (old('noHP')) ? old('noHP') : $pasien['no_telfone'] ?>">
                        </td>
                    ...
                    <tr>
                        ...
                        <td><input type="date" name="tanggalLahir" id="tanggalLahir" style="width: 270px;"
                                value="<?= (old('tanggalLahir')) ? old('tanggalLahir') : $pasien['tanggal_lahir'] ?>">
                        </td>

                        <td><label for="alamat">Alamat</label></td>
                        <td><input type="text" name="alamat" id="alamat" style="width: 270px;"
                                value="<?= (old('alamat')) ? old('alamat') : $pasien['alamat'] ?>"></td>
                    ...
                    <tr>
                        ...
                        <td><select name="jenisKelamin" id="jenisKelamin" style="width: 270px;">
                                <option value="Laki Laki"
                                    <?= (old('jenisKelamin')) ? ((old('jenisKelamin') == 'Laki Laki') ? 'selected' : "")
                                                                : (($pasien['jenis_kelamin'] == 'Laki Laki') ? 'selected' : "")  ?>>
                                    Laki - Laki</option>
                                <option value="Perempuan"
                                    <?= (old('jenisKelamin')) ? ((old('jenisKelamin') == 'Perempuan') ? 'selected' : "")
                        ...
                        <td>
                            <input class="<?= ($validation->hasError('noRM') ? 'is-invalid' : ''); ?>" type="text"
                                name="noRM" id="noRM" style="width: 270px;"
                                value="<?= (old('noRM') ? old('noRM') : $pasien['no_rm']) ?>">
                            <div class="invalid-feedback">
                        ...
                        <td class="fw-bold text-light">
                            ...
                            <button type="button" name="btData" style="margin-left: 4px; margin-top: 10px;"
                                class="bg-info fw-bold text-light"> <img src="/img/data.png" width="20px" height="20px"
                                    class="mb-1"> <a href="/pasien/data_pasien" class="to_data"
